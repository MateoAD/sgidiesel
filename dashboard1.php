...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('./img/fondo_panel.png'); /* Reemplaza con la ruta correcta de tu imagen */
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background-color: rgba(255, 255, 255, 0.1); /* Color blanco con 70% de opacidad */
            z-index: -1;
        }
...
<body class="bg-gray-50 min-h-screen">
  ...
  <div class="container mx-auto px-6 py-4 flex justify-between items-center">
    ...
    <div class="flex items-center space-x-4" >
      ...
      <div class="border-l-2 border-white pl-4">
        ...
        <p class="text-sm text-gray-200">Servicio Nacional de Aprendizaje</p>
      </div>
    </div>
  ...
  <span class="font-medium text-white whitespace-nowrap">
    ...
    <div class="container mx-auto p-6">
        <!-- Panel Principal -->
        <div class="polymorphic-container bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-2xl shadow-lg mb-8 transition-all duration-500 hover:shadow-xl">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">PANEL DEL INSTRUCTOR</h1>
            <p class="text-gray-600 mb-6">Bienvenido al sistema de gestión de inventario del Taller Diesel. Seleccione una opción para continuar.</p>
            
            <!-- Opciones principales con colores de la imagen -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                <!-- Ver Inventario -->
                <div class="bg-inventario text-white p-6 rounded-xl cursor-pointer card-hover transform hover:-rotate-1">
                    <a href="inventario.php"><div class="flex flex-col items-center text-center">
                ...
                <div class="bg-prestamo text-white p-6 rounded-xl cursor-pointer card-hover transform hover:rotate-1">
                    <a href="prestamos.php"><div class="flex flex-col items-center text-center">
                        <div class="bg-white bg-opacity-20 p-4 rounded-full mb-4 shadow-inner">
                ...
                <!-- Ver Préstamos -->
                <div class="bg-ver-prestamos text-white p-6 rounded-xl cursor-pointer card-hover transform hover:-rotate-1">
                    <a href="reporte.php"><div class="flex flex-col items-center text-center">
                        <div class="bg-white bg-opacity-20 p-4 rounded-full mb-4 shadow-inner">
                ...
                <div class="bg-aprendices text-white p-6 rounded-xl cursor-pointer card-hover transform hover:rotate-1">
                    <a href="aprendicez.php"><div class="flex flex-col items-center text-center">
                        <div class="bg-white bg-opacity-20 p-4 rounded-full mb-4 shadow-inner">
       ...
       <!-- Actividad Reciente -->
<div class="polymorphic-container bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-2xl shadow-lg mb-8 transition-all duration-500 hover:shadow-xl">
    <h2 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-3">ACTIVIDAD RECIENTE</h2>
    
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Herramientas Prestadas -->
        <div id="herramientas-prestadas" class="polymorphic-card bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="mt-4">
                    <span class="inline-block bg-blue-200 text-blue-800 px-3 py-1 rounded-full text-xs font-semibold">
        ...
        <!-- Préstamos Activos -->
        <div id="prestamos-activos" class="polymorphic-card bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl relative overflow-hidden">
            <div class="absolute -right-4 -bottom-4 opacity-20">
        ...
        <!-- Fecha Actual -->
        <div id="fecha-actual" class="polymorphic-card bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl relative overflow-hidden">
            <div class="absolute -right-4 -bottom-4 opacity-20">
            ...
            <div class="relative z-10">
                ...
                <div class="mt-4">
                    <span class="inline-block bg-purple-200 text-purple-800 px-3 py-1 rounded-full text-xs font-semibold">
                        <i class="fas fa-sync-alt mr-1"></i> Actualizado: <span id="hora-actualizacion"><?= date('H:i') ?></span>
                    </span>
                </div>
            </div>
        </div>
...
<div class="polymorphic-container bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-2xl shadow-lg mb-8">
    <h2 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-3">
        <i class="fas fa-history mr-2"></i>REGISTRO DE AUDITORÍA <span class="text-sm font-normal text-gray-600">(Últimos 5 registros)</span>
    </h2>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div class="relative">
            <select id="audit-action-filter" class="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
...
` : `
    <button onclick="cambiarRol(${user.id}, 'administrador')" 
...
<button onclick="eliminarUsuario(${user.id})" 
        class="text-red-600 hover:text-red-900 flex items-center rounded-lg px-3 py-1.5 bg-red-100 hover:bg-red-200">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setInterval(cargarDatosActividad, 60000);
...
// Función para aplicar el efecto lupa a elementos seleccionados
document.addEventListener('DOMContentLoaded', function() {
        // Configuración
        const magnifySelector = '.card-hover, .table td, .table th, button, a, .info-card, .polymorphic-card, p, h1, h2, h3, h4, h5, h6, span, li, .valor, .text-gray-700, .text-gray-600, .font-medium, .font-bold'; 
        const magnifyScale = 1.1; // Factor de escala (1.1 = 10% más grande)
        
        // Aplicar clase a todos los elementos seleccionados
        document.querySelectorAll(magnifySelector).forEach(element => {
            element.classList.add('magnify-effect');
            
            // Ajustar el factor de escala personalizado si es necesario
            element.style.setProperty('--magnify-scale', magnifyScale);
        });
        
        // Opcionalmente: Crear un efecto de lupa más avanzado para imágenes
        document.querySelectorAll('img').forEach(img => {
            img.classList.add('magnify-effect');
